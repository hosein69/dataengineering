...
FONT_STACK = ("'IRANSans','IRANSansX','IRANSans Light',"
              "'Segoe UI',Tahoma,Arial,sans-serif")
FONT_STACK_NUM = ("'IRANSans','Segoe UI',Tahoma,Arial,sans-serif")
...
TYPE: Dict[str, TypeStyle] = {
    "display": TypeStyle(32, 800, 1.35, -0.3),
    "h1":      TypeStyle(25, 800, 1.40, -0.2),
    "h2":      TypeStyle(20, 800, 1.45),
    ...
    "overline": TypeStyle(11, 800, 1.40, 0.6),
    "metric":  TypeStyle(26, 800, 1.20, -0.4),
    "metric-sm": TypeStyle(19, 800, 1.25, -0.2),
}
