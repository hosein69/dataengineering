...
DEFAULT_LAYOUT: List[BlockSpec] = [
    ...
    {"id": "insight", "type": "insight_row", "size": "full", "order": 1,
     "visible_for": [], "props": {}},
    {"id": "conformance", "type": "conformance", "title": "امتیاز انطباق", "size": "quarter",
    ...
    {"id": "variants", "type": "variant_explorer", "title": "کاوشگر واریانت", "size": "third",
     "order": 4, "visible_for": ["manager", "analyst"], "props": {}},
    {"id": "root_cause", "type": "root_cause", "title": "ریشه‌یابی", "size": "quarter",
     "order": 5, "visible_for": ["analyst"], "props": {}},
    {"id": "intensity", "type": "intensity_chart", "title": "روند حجم کیس",
     "size": "half", "order": 6, "visible_for": ["executive", "manager", "analyst"], "props": {}},
    {"id": "evidence", "type": "evidence_table", "size": "full", "order": 7,
     "visible_for": ["manager", "analyst"], "props": {}},
    {"id": "heatmap", "type": "heatmap", "title": "شدت فعالیت هفتگی", "size": "half",
     "order": 8, "visible_for": ["manager", "analyst"], "props": {}},
    {"id": "system", "type": "system_flow", "title": "خط لولهٔ سیستمی", "size": "half",
     "order": 9, "visible_for": ["manager", "analyst"], "props": {}},
    {"id": "kanban", "type": "kanban", "title": "وضعیت کیس‌ها در هر مرحله", "size": "full",
     "order": 10, "visible_for": ["analyst"], "props": {}},
]
