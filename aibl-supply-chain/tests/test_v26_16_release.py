...
def main():
    from aibl.factsheet import VERSION, DASHBOARD_SHEETS
    from aibl.studio_core.grain import measure_kind, safe_agg, KIND_ADDITIVE
    from aibl.studio_core.access import apply_access_scope
    from aibl.studio_core.templates import TEMPLATES
    from aibl.studio_core.html_export import build_dynamic_html
    from aibl.report.history import snapshot
