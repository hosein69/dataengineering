...
def test_unknown_not_zero():
    ...
    check("Unknown ≠ Zero: فقدان موجودی سازنده مقاومت قطعی نمی‌سازد",
          r.band == "UNKNOWN" and r.resistance_days is None and r.supplier_qty is None,
    ...
    check("فرمول پنج‌جزئی: Oracle + سه سبد کارشناسی",
          r2.total_confirmed == 480 and abs((r2.resistance_days or 0)-48) < .01,
