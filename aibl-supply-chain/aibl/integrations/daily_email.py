...
#: رنگ‌ها از نظام آکوا (`aibl/report/aqua.py`) — ایمیل هم باید
#: کنار اکسل و داشبورد مثل یک محصول دیده شود.
from ..report import aqua

THEME, NAVY = aqua.LIGHT["brand-strong"], aqua.LIGHT["header"]
RED, ORANGE, YELLOW, GREEN, GREY = "#C0392B", "#F39C12", "#F1C40F", "#27AE60", "#95A5A6"
BG, BORDER, TEXT = (aqua.LIGHT["surface"], aqua.LIGHT["border"],
                    aqua.LIGHT["text"])
