...
#: رنگ **متن** روی تراشهٔ وضعیت (پس‌زمینهٔ تراشه همان رنگ وضعیت با ۱۰٪
#: شفافیت است). رنگ خام وضعیت روی آن ته‌رنگ، متنی ۱۲ پیکسلی با نسبت
#: ۲٫۰۶ تا ۴٫۴ می‌داد — زیر حد خوانایی. این مقدارها با تیره‌کردن گام‌به‌گام
#: تا رسیدن به ≥۴٫۶:۱ روی بدترین سطح (#E1F2E9) محاسبه شده‌اند، نه انتخاب
#: سلیقه‌ای. نقطهٔ رنگی تراشه رنگ خام را نگه می‌دارد تا معنا عوض نشود.
STATUS_ON_TINT_LIGHT: Dict[str, str] = {
    "good": "#29702D",
    "warning": "#825B00",
    "serious": "#9E4A1A",
    "critical": "#B3261E",
...
#: ایران‌سنس **اول** است. قبلاً Vazirmatn اول بود و روی ماشینی که هر دو
