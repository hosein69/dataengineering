...
<style>
  ...
  .kpi-wrap .kpi .val{{font-size:26px;font-weight:800;color:{T.INK};margin-top:8px;
...
<style>
  ...
  .insight-wrap .insight .head{{font-size:24px;font-weight:800;line-height:1.2;color:{T.INK};
...
<style>
  ...
  .evtable .gap{{font-size:15px;font-weight:800;color:{T.STATUS['warning'].ink};
