...
def run():
 ...
 import pathlib
 h=build_email_html(d,df,[],p["excel"]); check("نام Excel در ایمیل", "Systemmatic Material.xlsx" in h); check("علت متریال در ایمیل", "M1: بحرانی" in h); check("دعوت به Excel", "جزئیات تصمیم" in h and "Excel" in h); check("فونت ایمیل IRANSans Light است", "IRANSans Light" in h); check("بدون CSS خارجی", "fonts.googleapis.com" not in h)
