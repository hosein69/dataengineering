...
CODES: Tuple[DefectCode, ...] = (
    ...
    _c("FIELD_NEVER_POPULATED", MISSING, COMPLETENESS, SOURCE_CONTRACT,
       "این فیلد هرگز پر نمی‌شود",
       "هیچ پرونده‌ای مقدار ندارد — احتمالاً نگاشت سورس به این ستون وجود ندارد. "
       "پیش از درخواست تکمیل از کارشناسان، مسیر خواندن این فیلد را بررسی کنید."),
    _c("SOURCE_DISAGREEMENT", CONFLICT, CONSISTENCY, INVESTIGATION,
       "سورس‌ها عدد متفاوت می‌دهند",
       "چند سورس برای یک پرونده مقدار متفاوت ثبت کرده‌اند. تا وقتی مشخص نشود کدام درست است، "
       "این عدد مبنای تصمیم نیست — انتخاب خودکارِ یکی از آن‌ها یعنی قبول‌کردن ریسک غلط‌بودنش."),
    _c("CURRENCY_DISAGREEMENT", CONFLICT, CONSISTENCY, INVESTIGATION,
       "سورس‌ها ارز متفاوت می‌دهند",
       "یک مبلغ با دو ارز متفاوت ثبت شده است. عدد یکسان با ارز متفاوت، دو مبلغ کاملاً متفاوت "
       "است؛ پیش از هر جمع یا مقایسه‌ای باید تعیین تکلیف شود."),
